...
In general the folder structure of each  FHIRconnect project is up to the vendor. The official https://github.com/SevKohler/FHIRconnect-mapping-lib/tree/main[library] follows
