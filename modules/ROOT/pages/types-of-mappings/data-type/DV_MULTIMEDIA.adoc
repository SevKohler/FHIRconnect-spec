...
== Attachement
https://specifications.openehr.org/releases/RM/latest/data_types.html#_dv_multimedia_class[DV_MULTIMEDIA] to https://build.fhir.org/datatypes.html#attachment[Attachment]

[IMPORTANT]
====
The compression algorithm is missing, which may cause problems in transforming data if contained.
====
