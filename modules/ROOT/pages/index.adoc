...
The reasoning behind the design — why things are the way they are — is documented as architecture
decision records (arc42 §9) in the xref:architecture-decisions/architecture-decisions.adoc[Architecture Decisions]
chapter, and linked from the pages where a decision applies.
